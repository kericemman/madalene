...
const variants = {
  ...
  darkPrimary:
    "border border-mistWhite bg-mistWhite text-charcoal shadow-[0_16px_30px_rgba(26,26,26,0.18)] hover:border-mutedMint hover:bg-mutedMint focus-visible:outline-mutedMint",
  darkSecondary:
  ...
  lightPrimary:
    "border border-deepEmerald bg-deepEmerald text-mistWhite shadow-[0_12px_28px_rgba(15,77,62,0.18)] hover:border-charcoal hover:bg-charcoal focus-visible:outline-deepEmerald",
  lightSecondary:
  ...
  blackGreen:
    "border border-charcoal bg-charcoal text-mutedMint shadow-[0_12px_24px_rgba(26,26,26,0.18)] hover:border-deepEmerald hover:bg-deepEmerald hover:text-mistWhite focus-visible:outline-deepEmerald",
  nav:
    "border border-deepEmerald bg-deepEmerald px-4 py-2.5 text-mistWhite shadow-[0_12px_24px_rgba(15,77,62,0.2)] hover:border-mutedMint hover:bg-mutedMint hover:text-charcoal focus-visible:outline-mutedMint"
};
